...
namespace Foundation
{
    ...
    public class NSMutableArray : NSArray
    {
        ...
        [Export("insertObject")]
        public void InsertObject(AnyObject anObject, int index) { }
        ...
        public void InsertObjects(AnyObject[] objects, NSIndexSet indexes) { }
        ...
        [Export("removeObject")]
        public void RemoveObject(AnyObject anObject, NSRange aRange) { }
        ...
        [Export("removeObjectIdenticalTo")]
        public void RemoveObjectIdenticalTo(AnyObject anObject, NSRange aRange) { }
        ...
        public void RemoveObjectsFromIndices(CMutablePointer<int> indices, int count) { }
        ...
        public void ReplaceObjectAtIndex(int index, AnyObject anObject) { }
        ...
        /// <param name="index">The index of the object to be replaced. This value must not exceed the bounds of the array. !!Important!! Raises an NSRangeException if index is beyond the end of the array.</param>
        [Export("setObject")]
        public void SetObject(AnyObject anObject, int index) { }
        ...
        public void ReplaceObjectsAtIndexes(NSIndexSet indexes, AnyObject[] objects) { }
        ...
        public void ReplaceObjectsInRange(NSRange aRange, AnyObject[] otherArray, NSRange otherRange) { }
        ...
        /// <param name="otherArray">The array of objects from which to select replacements for the objects in aRange.</param>
        [Export("replaceObjectsInRange")]
        public void ReplaceObjectsInRange(NSRange aRange, AnyObject[] otherArray) { }
        ...
        public void SortWithOptions(NSSortOptions opts, NSComparator cmptr) { }
